...
Semua file dokumentasi project (kecuali README utama di root) disimpan di folder ini.

## Daftar Dokumen

| File | Deskripsi |
|------|-----------|
| [QUICK_START.md](QUICK_START.md) | Panduan cepat run lokal |
| [LOCAL_SETUP.md](LOCAL_SETUP.md) | Panduan lengkap setup & run lokal |
| [INSTALL_GO_WINDOWS.md](INSTALL_GO_WINDOWS.md) | Cara install Go di Windows |
| [DEPENDENCIES.md](DEPENDENCIES.md) | Daftar dependencies & cara manage |
...
README utama project ada di [../README.md](../README.md).
